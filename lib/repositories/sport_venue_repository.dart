...
import 'package:flutter_application/models/sport_venue_api.dart';
import 'package:http/http.dart';

class SportVenueRepository {
  Future<List<SportVenueAPI>> fetchSportVenues(String query) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (json.containsKey("results")) {
        ...
        for (Map<String, dynamic> result in results) {
          final SportVenueAPI sportvenue = SportVenueAPI.fromGeoJson(result);
